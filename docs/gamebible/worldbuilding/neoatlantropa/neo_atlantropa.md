...
## 2. Origini del Concetto
Neo Atlantropa ha le sue radici nell’idea originale di [Atlantropa](https://it.wikipedia.org/wiki/Atlantropa), progetto dell’architetto tedesco *Herman Sörgel* presentato nel 1928.

Sörgel propose la costruzione di dighe tra:

- lo Stretto di Gibilterra;
- il Bosforo:
- lo stretto tra Sicilia e Tunisia.

per abbassare il livello del Mediterraneo e generare energia idroelettrica.

Questa visione utopica fu ripresa dalla Comunità Europea nel XXI secolo in risposta alla crisi energetica globale, dando vita a Neo Atlantropa.
...
- opportunità agricole e minerarie su scala senza precedenti.

### 3.3. Domanda di Risorse e Pressione Geopolitica
Le potenze europee investirono risorse enormi nel progetto per affrontare:
- il collasso delle riserve di petrolio;
- le tensioni crescenti tra nazioni per l’accesso alle materie prime;
...
## 5. Conseguenze Geografiche e Ambientali
### 5.1. Prosciugamento del Bacino
La lunga opera di Neo Atlantropa, unita ai cambiamenti climatici globali e alle instabilità politiche, porta a:
- abbassamento progressivo dei livelli del mare;
- emersione di grandi porzioni di fondale;
...
- crea il terreno su cui si sviluppano gli scenari post-apocalittici descritti nella documentazione di lore;
- fornisce una spiegazione “tecnica” e coerente del prosciugamento del Mediterraneo;
- serve come elemento narrativo vero e proprio nel world-building di MAT-TSL.
