---
title: Neo Atlantropa - Cause ed Effetti
---
...
- crescente costo delle materie prime;
- pressione industriale per nuove superfici sfruttabili:
  - agricole;
  - minerarie;
  - logistiche;

## Cause Tecnologiche
- fiducia eccessiva nella capacità di controllare sistemi naturali complessi;
- sottovalutazione degli effetti cumulativi a lungo termine;
- dipendenza da infrastrutture centralizzate vulnerabili al collasso politico e militare.

## Effetti Ambientali
- prosciugamento progressivo del Mediterraneo;
...
- abbandono di città portuali divenute inutilizzabili;
- nascita di comunità adattate al deserto post-marino;
- sviluppo di nuove culture legate alla sopravvivenza in ambienti estremi.

## Effetti Politici Postbellici
- frammentazione del controllo territoriale;
- comparsa di fazioni che rivendicano:
