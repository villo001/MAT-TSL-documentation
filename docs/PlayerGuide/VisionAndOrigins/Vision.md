...
...però come tutti gli appassionati vorremmo sapere cos'è successo al Belpaese.

Perché le ambientazioni nordamericane sono affascinanti ed esotiche ma una ambientazione in Italia sarebbe per noi realmente coinvolgente.

E soprattutto ci piacerebbe immaginare che l'Italia _se la sia cavata_, tutto sommato, grazie al nostro ingegno e alla nostra fortuna.
...
- Collasso globale delle riserve petrolifere.
- Aumento incontrollato del fabbisogno energetico.
- 2052: Crisi Petrolifera Globale.
- Crollo economico di numerosi stati.
- Le superpotenze iniziano a investire in energia alternativa:
  - Fusione fredda
  - Microcelle a fusione
  - Reattori nucleari miniaturizzati

Va bene, ma in Italia?

---

## 2. Conflitti Regionali e Instabilità (2052–2060)
- Tensioni in Europa e Medio Oriente per le ultime riserve energetiche.
- Instabilità politica diffusa.
- Aumento dei conflitti territoriali, commerciali e militari.

Questo già ci interessa di più.

---

## 3. Conflitto sino americano per l’Alaska (2060–2077)
### 3.1 Motivazioni
- La Cina dipende dal petrolio importato.
- Gli USA scoprono grandi giacimenti in Alaska.
- La Cina tenta di assicurarsi il controllo di quelle risorse.

Questo è specifico del Nord America, ma in Italia?

### 3.2 Svolgimento
- 2066: La Cina invade l’Alaska.
- Gli USA rispondono militarizzando la regione:
  - Prima armatura avanzata.
  - Armi energetiche avanzate.
  - Automazione militare e robotica.

Anche questo è specifico del Nord America, ma in Italia?

### 3.3 Estensione del Conflitto al Canada
- Operazioni militari si espandono a nord.
- Tensioni con la popolazione canadese.

Di nuovo specifico del Nord America, ma in Italia?

---

## 4. Militarizzazione Totale e Annessione del Canada (2072–2076)
- Pressioni militari e logistiche degli USA.
- Proteste civili e resistenza canadese.
- 2076: Annessione forzata del Canada.
- Soppressione delle libertà civili e militarizzazione degli USA.

Sempre specifico del Nord America, ma in Italia?

---

## 5. Ultimi Anni della Crisi (2076–2077)
- Gennaio 2077: cacciata delle forze cinesi dall’Alaska.
- Le tensioni globali raggiungono il punto di non ritorno.
- Instabilità politica irreversibile.

Ulteriormente specifico del Nord America, ma in Italia?
...
Più nordamericano di così si muore, ma in Italia?
...
- 2052: Crisi Petrolifera Globale.
- 2050-2060: Collasso economico di varie regioni.

### 2052-2060: Conflitti regionali
- Instabilità diffusa in Europa.
- Guerre locali in Medio Oriente.

### 2060-2077: Guerra sino americana
- 2060-2066: Tensioni crescenti.
- 2066: Invasione cinese dell’Alaska.
- 2070: Gli USA testano la prima armatura avanzata.
- 2072: Intensificazione della guerra.
- 2073-2076: Espansione del conflitto al Canada.

### 2072-2076: Canada
- 2072-2076: Repressioni e violenze.
- 2076: Annessione forzata del Canada.
...
Una timeline dettagliata canonica del periodo la puoi trovare [qui](docs/timeline_schematica.md).
...
- Progressivo collasso energetico nel 2060.
- Decisione aggressiva: invasione dell’Alaska nel 2066.
- Sforzo bellico totale durato oltre dieci anni.
- Forte propaganda antiamericana.
- Dopo il primo lancio, lancia a sua volta e poi subisce parte degli ordigni termonucleari nel 2077.

## 3. Europa
- L'Unione Europea nell'universo di gioco della Saga è implosa sotto il peso della crisi energetica.
- Tensioni interne per la ripartizione delle risorse.
- Diversi conflitti locali fra nazioni europee.
- Lo scenario europeo è caratterizzato da:
  - carestie;
  - recessioni;
  - rivolte interne.
- Alla vigilia del 2077, l’Europa non è più un attore geopolitico unitario.

---

# La situazione italiana
A questo punto cambiamo registro perché iniziamo a muoverci sulle sabbie mobili, esistono poche notizie certe dell'Europa e praticamente nessuna dell'Italia.

Dobbiamo per forza immaginare ed estrapolare, e se si immagina e si estrapola si può ottenere di tutto, basta rimanere coerenti con la Lore ufficiale.
...
- dopo la guerra, come in tutte le aree non rappresentate nei giochi principali, il territorio potrebbe essere stato teatro di:
  - insurrezioni locali,
  - scontri con predoni o bande locali,
...
## Ora interveniamo noi
Queste conclusioni non ci piacciono: non sono ufficiali, sono estrapolate da lavori di gruppi di fan e noi __siamo fan__.

Quindi andiamo a proporre la nostra visione della storia, visione la più coerente possibile con il canone della Saga.

## Ipotesi: i punti fermi
...
Quattro testate su un territorio come quello italiano (anche per motivi orografici) non riescono a generare quella radioattività che si trova nella Saga originale, quindi il territorio italiano può essere ritenuto indenne da questo problema (tranne nei dintorni luoghi di impatto).

### Dati di fatto: eccellenza nella ricerca pura e industriale
Ad oggi l'Italia ha ottimi istituti/enti di ricerca, molto quotati a livello internazionale:
  - L'Agenzia nazionale per le nuove tecnologie, l'energia e lo sviluppo economico sostenibile (una volta ENEA, Ente Nazionale Energie Alternative). [Fonte: Wikipedia](https://it.wikipedia.org/wiki/Agenzia_nazionale_per_le_nuove_tecnologie,_l%27energia_e_lo_sviluppo_economico_sostenibile)
  - Il Consiglio Nazionale delle Ricerche (CNR). [Fonte: Wikipedia](https://it.wikipedia.org/wiki/Consiglio_Nazionale_delle_Ricerche)
...
Questo progetto, [Neo Atlantropa](https://villo001.github.io/MAT-TSL-documentation/GameBible/WorldBuilding/NeoAtlantropa/Neo_Atlantropa.html), è stato l'ultimo scatto disperato prima della fine.

---

# Lo scenario

Ora diventa semplice tratteggiare il nostro scenario su cosa è successo in Italia.
...
- il centro finanziario del paese (Milano) è completamente annullato.
- il centro del potere politico (Roma) è completamente annullato.
- il centro dell'industria militare (Napoli) è completamente annullato.

Cosa rimane?

Moltissimo in realtà.

Ampi comparti manifatturieri rimangono intatti (Bergamo-Brescia e Bologna, solo per citare il nord).

Le principali sedi della ricerca scientifica rimangono intatti (Università di Bologna e comparto nord est, sempre per citare il settentrione).
...
Tutto ciò ci condannerebbe ad una fine dolorosa e breve. Noi e gli altri paesi europei.

O, almeno, questo è quello che accadrebbe secondo la lore ufficiale.

Se vogliamo che l'Italia _se la sia cavata_ (come dicevamo all'inizio) serve necessariamente un punto di rottura con il quale l'Italia diverga dal destino che sembrerebbe indicato dalla lore ufficiale, e ovviamente dobbiamo trovarne uno che non sia in contrasto con la lore.

A questo punto eravamo ad un punto morto, veramente a corto di idee e per uscire dall'impasse abbiamo provato a sperimentare con strumenti di IA.
...
Avevo già letto del progetto Atlantropa, sembrava una pista promettente per trovare un possibile punto di rottura e ho iniziato a chattare con la IA per trovare più informazioni possibili.

Una delle prime cose che mi ha trovato è stata il paragone con la Crisi di Salinità del Messiniano dandomi anche il link a Wikipedia. L'ho seguito e la seconda immagine mi ha letteralmente fatto strabuzzare gli occhi: il mare Adriatico semplicemente non esisteva!

Linko l'immagine per comodità:
![Ricostruzione del bacino nel periodo di massima essiccazione.](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Etapa3.jpg/1280px-Etapa3.jpg)

Ora, il mare Adriatico è un mare molto particolare, abito a 60 Km dalle sue coste, sono un velista e lo conosco bene.

Si tratta di un mare poco profondo, veramente poco profondo, nella parte più a nord non supera i venti metri di profondità, e la sua batimetria è peculiare perché è dovuta all'azione dei grandi fiumi della pianura padana e friulana che apportanosabbia e limo: il fondale è una piana digradante dolcemente con direzione da nord ovest a sud est, praticamente un fondale piatto formato da sabbia e limo.
...
Non c'è soluzione di continuità fra coste e fondali, tutto digrada dolvemente, lasciando un ambiente unico formato da limo e sabbia.

Con il cervello che girava a mille mi si è presentato uno scenario affascinante: in vari secoli di mare Adriatico asciutto i venti e l'erosione hanno portato alla formazione di un deserto di dune di sabbia, un vero e proprio [Erg](https://it.wikipedia.org/wiki/Erg_(deserto)), un ambiente molto simile a quello de i grandi Erg orientali e occidentali dell'Algeria, insomma il deserto per antonomasia.

Ed è esattamente in questo ambiente, ho pensato, che si deve trovare il bandolo della matassa, il punto in cui la nostra lore diverge da quella canonica.

A tutto ciò è seguito un periodo in cui mi sono documentato sulla formazione dei deserti, sulla loro sostenibilità come ambienti stabili, ecc...

Ovviamente ho continuato ad usare la IA per ricerche, riassunti, per farmi presentare liste di proposte e scenari e tutto tornava, dopo il prosciugamento in pochi decenni si sarebbe potuto formare un deserto simile a quello che avevo in mente.

Direi uno sparo nel buio riuscito molto bene.
...
Dopo parecchi tentativi ho deciso di usare nuovamente la IA per un brainstorming, in poche parole un secondo sparo nel buio.

## 3. Uno sparo nel buio 2 - La vendetta
Ho iniziato istruendolo per bene sul destino del mare Adriatico, spiegando tutto quello che abbiamo visto fino ad ora e chiedendo un riassunto e varie considerazioni.

Fra le considerazioni la risposta indicava che il mare Adriatico oltre a tutte quelle caratteristiche ha anche quella di essere molto inquinato e di avere fondali molto inquinati, compresi metalli pesanti.

Prima lampadina accesa, prosciugandosi tutti gli strati inquinati avrebbero preso parte al processo di erosione e sarebbero entrati a fare parte delle dune di sabbia.

Ho continuato inserendo tutto questo nelle domande che facevo, e fra le risposte ho notato le biotecnologie come filone di ricerca e microorganismi mutati come effetto di tutti gli inquinanti presenti nel deserto.

Seconda lampadina accesa, le biotecnologie richiedono meno energia per essere portate avanti e la ricerca in quel campo potrebbe partire eccome dalla scoperta di nuovi microorganismi mutati.

Ok, la risposta potrebbe essere in questo scenario, ma come si può ottenere energia con le biotecnologie da microorganismi mutati.

La risposta della IA è stata secca e concisa. Mi ha molto stupito, probabilmente nel suo training e nelle domande di altre persone si erano già toccati questi argomenti.

Bioelettricità.

Come nelle [torpedini](https://it.wikipedia.org/wiki/Torpediniformes) che sono in grado di emettere scosse elettriche di notevole intensità, già usate dagli antichi Romani nella terapia per i dolori artritici.
...
Ovviamente la scoperta è da subito un segreto industriale e militare, viste le caratteristiche e le potenzialità, e questo spiega perché solo noi ce la siamo cavata.
...
Iniziamo a dettagliare maggiormente i vari aspetti della tecnologia, per vedere se il castello rimane in piedi.

### 4.1 La Tecnologia
Una volta scoperti di può pensare ad una tecnologia semplice, accedibile anche artigianalmente per produrre
- biopannelli, semplici strati uniformi di microorganismi in un sandwich composto da una parte inferiore riflettente e una parte superiore trasparente, producono elettricità se esposti al sole
- bionuclei, semplici contenitori ceramici con la superficie superiore trasparente e contenenti microorganismi concentrati ad alta pressione, producono elettricità fino a che i microorganismi si _scaricano_ e vanno in letargo; si riattivano (ricaricano) esponendoli al sole per qualche giorno
- biocelle, contenitori ceramici contenenti microorganismi ad altissima concentrazione e ad alta pressione, si scaricano istantaneamente provocando la morte dei microorganismi stessi

Con questo si alimenta tutto:
- campi di biopannelli per grosse infrastrutture
...
Anche se su piccola scala si innesca una rinascita industriale, di occupazione e demografica alimentata dalla bioelettricità ma contemporaneamente il tutto è anche frenato dalla scarsezza di risorse idriche che penalizzano la produzione agricola.

Al crollo della Comunità Europea le prospettive vengono ridimensionate anche a causa del fallimento di Neo Atlantropa ma siamo comunque in un circolo virtuoso di produzione di bioelettricità che alimenta la produzione industriale che permette anche di trivellare per ottenere acqua dalle falde profonde la quale permette di sviluppare maggiormente l'agricoltura.
...
Siccome l'autorità centrale politica e militare è scomparsa il territorio si frammenta:
- piccole realtà locali che si raccolgono attorno a reparti militari sopravvissuti
- realtà tecnologiche locali che con il monopolio della produzione locale prende il sopravvento, si militarizzano e iniziano a comportarsi tout court da centri di comando e di potere
- autorità religiose locali scollegate fra di loro che iniziano ad agire a loro volta da centri di potere in lotta uno con l'altro per il controllo del territorio
- città universitarie con i loro centri di ricerca che iniziano a comportarsi da territori autonomi, militarizzandosi
- distretti industriali che iniziano a comportarsi da territori autonomi, militarizzandosi a loro volta
- comunità di raccoglitori di microorganismi su quella che era la vecchia costa, popolazioni indipendenti che in un certo senso controllano quella che è diventata una risorsa fondamentale e che si specializzano nel commercio
- bande di scavenger, razziatori e predoni che vivono ai margini dei territori consolidati, a volte anche organizzati, a volte addirittura usati come mercenari per reperire risorse in operazioni militari fra i vari centri di potere

Tutti questi centri di potere controllano anche zone rurali nei loro dintorni che servono per la loro sussistenza.
...
Però ora non mi sono fatto fregare, ho pensato subito in modo laterale e sono giunto alla conclusione che non si tratta specificatamente della radioattività ma di un __pericolo ambientale__.

Nei giochi della Saga la radioattività funzionalmente svolge il ruolo di pericolo ambientale che inizia a farti danni se ri avvicini:
- zone irradiate (terreno o acqua), se entri inizi a prendere danni
- bidoni radioattivi, se ti avvicini inizi a prendere danni

Identificato il ruolo diventa semplice trovare la soluzione: sempre microorganismi mutati.

Abbiamo già stabilito che solo un certo tipo di microorganismi produce bioelettricità.

Gli altri tipi sono tossici, semplice, se entri in una zona e ci sono, inizi a prendere danni, se ti avvicini ad un bidone di scarti del processo di purificazione che veniva svolto negli impianti prebellici, prendi danni.
...
O una nutria diventata bipede e alta due metri, con artigli affilatissimi?
...
Abbiamo già visto una intera saga di fantascienza basata su questo plot, un intero pianeta desertico che è l'unico posto nella galassia dove si può trovare una spezia geriatrica che allunga la vita, espande la mente e permette anche i viaggi interstellari e che è prodotta da vermi giganteschi che sono di fatto i padroni del deserto.
